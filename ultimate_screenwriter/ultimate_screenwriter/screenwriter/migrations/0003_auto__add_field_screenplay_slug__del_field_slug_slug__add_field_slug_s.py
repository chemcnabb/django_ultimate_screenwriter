...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Screenplay.slug'
        db.add_column(u'screenplay', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Slug.slug'
        db.delete_column(u'slug', 'Slug')

        # Adding field 'Slug.slugfield'
        db.add_column(u'slug', 'slugfield',
                      self.gf('django.db.models.fields.TextField')(default='', db_column='Slug', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Screenplay.slug'
        db.delete_column(u'screenplay', 'slug')

        # Adding field 'Slug.slug'
        db.add_column(u'slug', 'slug',
                      self.gf('django.db.models.fields.TextField')(default='', db_column='Slug', blank=True),
                      keep_default=False)

        # Deleting field 'Slug.slugfield'
        db.delete_column(u'slug', 'Slug')
