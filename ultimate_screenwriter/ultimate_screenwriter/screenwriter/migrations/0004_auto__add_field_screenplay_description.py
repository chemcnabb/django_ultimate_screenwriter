...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Screenplay.description'
        db.add_column(u'screenwriter_screenplay', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Screenplay.description'
        db.delete_column(u'screenwriter_screenplay', 'description')
