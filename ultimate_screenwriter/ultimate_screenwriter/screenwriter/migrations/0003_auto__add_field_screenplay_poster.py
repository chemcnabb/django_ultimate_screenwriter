...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Screenplay.poster'
        db.add_column(u'screenwriter_screenplay', 'poster',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Screenplay.poster'
        db.delete_column(u'screenwriter_screenplay', 'poster')
